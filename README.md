# <div align="center">🚀 XMAIL - 24小时临时邮箱服务</div>
...
XMAIL 现在采用全新的一体化部署方式，前端和后端整合为一个 Cloudflare Worker，部署更加简单！
...
<div align="center">
  <a href="http://deploy.workers.cloudflare.com/?url=https://github.com/zaunist/xmail" target="_blank">
...
完成部署与登录后，使用**已生成的 API Token**调用接口。
...
> ⚠️ 注意：
> 1. `https://<your-domain>` 必须绑定到部署了本项目的 Worker。  
> 2. 通过 API 创建 Token 已禁用，请使用你已有的 Token。  
> 3. 如果接口返回 `{"error":"not found"}`，通常是域名路由未指向本 Worker。
...
欢迎提交Pull Request或Issue来改进XMAIL项目！
