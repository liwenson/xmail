    ...
    return (
        <Container>
            ...
            <div className="mt-6 space-y-6">
                {/* 功能介绍 */}
                <section className="bg-card rounded-lg p-6 border shadow-sm transition-all duration-200 hover:shadow-md hover:border-primary/20">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                        <div className="space-y-3">
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    <h3 className="font-semibold">{t('intro.features.privacy.title')}</h3>
                            ...
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    <h3 className="font-semibold">{t('intro.features.temporary.title')}</h3>
                        ...
                        <div className="space-y-3">
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    <h3 className="font-semibold">{t('intro.features.anonymous.title')}</h3>
                            ...
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    <h3 className="font-semibold">{t('intro.features.instant.title')}</h3>
                ...
                <section className="bg-card rounded-lg p-6 border shadow-sm transition-all duration-200 hover:shadow-md hover:border-primary/20">
                    ...
                    <div className="space-y-4">
                        <div>
                            <h3 className="font-semibold mb-2">{t('intro.faq.q1.question')}</h3>
                            <p className="text-sm text-muted-foreground">{t('intro.faq.q1.answer')}</p>
                        </div>
                        <div>
                            <h3 className="font-semibold mb-2">{t('intro.faq.q2.question')}</h3>
                            <p className="text-sm text-muted-foreground">{t('intro.faq.q2.answer')}</p>
                        </div>
                        <div>
                            <h3 className="font-semibold mb-2">{t('intro.faq.q3.question')}</h3>
